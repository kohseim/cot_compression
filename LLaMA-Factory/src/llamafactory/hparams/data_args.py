...
class DataArguments:
    ...
    id_max_op: Optional[int] = field(
        default=14,
        metadata={"help": "The maximum operation id for in-distribution data."},
    )
    preset_path: Optional[str] = field(
        default="data/PRESET.json",
        metadata={"help": "The path to the preset json file."},
    )
    task_name: Optional[str] = field(
        default="composition/op_level",
        metadata={"help": "The task to use for composing datasets."},
    )
    task_setting: Optional[str] = field(
        default="id2-10_uniform",
        metadata={"help": "The setting to use for composing datasets."},
    )
    task_token_count: Optional[str] = field(
        default="10B",
        metadata={"help": "The total token count to use for composing datasets."},
    )
